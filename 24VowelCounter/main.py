...
╚══════════════════════════════════════════════════════╝
    ...
    def display_menu(self) -> None:
        ...
        print("📋 MAIN MENU")
        print("═" * 50)
        print("1️⃣  Input/Edit text")
        print("2️⃣  Count vowels")
        print("3️⃣  Full text analysis")
        print("4️⃣  Find words with most vowels")
        print("5️⃣  Vowel frequency analysis")
        print("6️⃣  Compare texts")
        print("7️⃣  Text statistics")
        print("8️⃣  Palindrome checker")
        print("9️⃣  Save/Load analysis")
        print("🔟  View history")
        print("0️⃣  Exit")
        print("═" * 50)
